<template>
  <div class="space-y-6">
    ...
    <div class="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h3 class="text-base font-bold text-stone-900 font-serif">Direktori Toko & Supplier</h3>
        <p class="text-xs text-stone-500">Database supplier bibit parfum, bahan kimia pelarut, botol, dan kemasan</p>
      </div>
